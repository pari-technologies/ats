...
export const MENU: MenuItem[] = [
  ...
  {
    id: 8,
    label: 'MENUITEMS.JDBUILDER.TEXT',
    icon: 'grid',
    subItems: [
      {
        id: 9,
        label: 'MENUITEMS.JDBUILDER.LIST.JDLIST',
        link: '/projects/list',
        parentId: 8,
      ...
      {
        id: 10,
        label: 'MENUITEMS.JDBUILDER.LIST.NEWJD',
        link: '/jdbuilderform',
        parentId: 8
      },
      // {
  ...
  },
  {
    ...
    subItems: [
      {
        id: 50,
        label: 'MENUITEMS.CANDIDATES.LIST.CLIST',
        link: '/candidates',
        parentId: 54,
      ...
      {
        id: 10,
        label: 'MENUITEMS.CANDIDATES.LIST.NEWCV',
        link: '/uploadcv',
        parentId: 54
      },

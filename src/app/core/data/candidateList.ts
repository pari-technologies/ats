...
export interface candidatelist {
    om_cand_id: string;
    om_cand_first_name: string;
    om_cand_last_name: string;
    om_cand_gender : string;
    om_cand_dob : string;
    om_cand_address : string;
    om_cand_exp_years : string;
    om_cand_profession : string;
    om_cand_summary : string;
    om_cand_license : string;
    om_cand_date_create : string;
    om_cand_status : string;
  }
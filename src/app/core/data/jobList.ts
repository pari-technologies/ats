...
export interface jobList {
    ...
    om_job_code : string;
    om_workplace : string;
    om_job_location : string;
    om_emp_location : string;
    om_job_desc : string;
    om_job_req : string;
    om_job_benefit : string;
    om_industry : string;
    om_function : string;
    om_empl_type : string;
    om_exp_level : string;
    om_education : string;
    om_exp_year : string;
    om_salary_from : string;
    om_salary_to : string;
    om_salary_currency : string;
    om_job_status : string;
    om_create_date : string;
  }
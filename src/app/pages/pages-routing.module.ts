...
import { JobComponent } from "./dashboards/job/job.component";
import { JDBuilderFormComponent } from "./jdbuilder-form/jdbuilder-form.component";
import { UploadcvComponent } from "./uploadcv/uploadcv.component";
import { GridViewComponent } from "./apps/jobs/candidate-lists/grid-view/grid-view.component";
import { ProfileComponent } from './extrapages/profile/profile/profile.component';
...
const routes: Routes = [
    ...
    {
      path: "jdbuilderform",
      component: JDBuilderFormComponent
    },
    {
      path: "candidates",
    ...
    // },
    // {
    //   path: "projects/overviews/:id",
    //   component: OverviewComponent
    // },
    // {
    //   path: "projects/overviews",
    //   component: OverviewComponent
    // },
    {
